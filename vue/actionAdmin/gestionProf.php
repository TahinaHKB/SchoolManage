...
?>
    <div class="col">
          <div class="card shadow-sm">
            <img src="image/prof/<?= $value['photo'] ?>" width="100%">
            <div class="card-body">
              <p class="card-text"><?= $appelation ?></p>
              <div class="d-flex justify-content-between align-items-center">
                <div class="btn-group">
                  <a href="main.php?id=<?=$value['Id']?>&perso=<?=$value['Appelation']?>"><button type="button" class="btn btn-sm btn-outline-secondary">Voir</button></a>
                </div>
...
?>
    ...
    <div class="row align-items-center g-lg-5 py-5">
      <div class="col-lg-7 text-center text-lg-start">
        <h1 class="display-4 fw-bold lh-1 mb-3">Ajouter un nouveau professeur</h1>
        <p class="col-lg-10 fs-4">Le professeur a la noble tâche d'enseigner des matières qu'ils maîtrisent aux élèves. Entrer ses informations correspondants et selectionner ses matières</p>
      </div>
      <div class="col-md-10 mx-auto col-lg-5">
		...
		?>
            ...
            <label>
              <input type="checkbox" name="<?=$value['Nom']?>" value="remember-me"> <?=$value['Nom']?>
            </label>
          </div>
		<?php 
			}
